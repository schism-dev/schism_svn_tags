...
!
! ifort -O2 -Bstatic -CB -assume byterecl -o gen_hot_3Dth_from_nc gen_hot_3Dth_from_nc.f90 ..../compute_zcor.f90 -I/share/apps/netcdf/include/ -L/share/apps/netcdf/lib/ -lnetcdf
! pgf90 -O2 -mcmodel=medium -Mbounds -Bstatic -o gen_hot_3Dth_from_nc gen_hot_3Dth_from_nc.f90 /sciclone/home04/yinglong/SELFE/svn/trunk/src/Utility/UtilLib/compute_zcor.f90 \
...
!           write(88,*)i,xcj(i),ycj(i),ssd(i,1),ssd(i,nvrt)
          ...
          do i=1,ne
            do k=2,nvrt
              tsel(k,i,1)=(sum(tempout(elnode(1:i34(i),i),k))+sum(tempout(elnode(1:i34(i),i),k-1)))/2/i34(i) 
              tsel(k,i,2)=(sum(saltout(elnode(1:i34(i),i),k))+sum(saltout(elnode(1:i34(i),i),k-1)))/2/i34(i)
            enddo !k
