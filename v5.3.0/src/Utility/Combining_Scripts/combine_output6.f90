...
!
!  Compile on tsunami:
!  ifort -Bstatic -O2 -assume byterecl -o combine_output6 combine_output6.f90 ../UtilLib/schism_geometry.f90 -Vaxlib -I/share/apps/netcdf/include/ -L/share/apps/netcdf/lib/ -lnetcdf

!  On TYPHOON:
!  pgf90 -O2 -mcmodel=medium  -Bstatic -o combine_output6 combine_output6.f90 ../UtilLib/schism_geometry.f90 -I/usr/local/amd64a/opteron/pgi/netcdf-3.6.2/include -L/usr/local/amd64a/opteron/pgi/netcdf-3.6.2/lib -lnetcdf

!  History: changed non-standard outputs which can be viz'ed with vis6 now (vertical
