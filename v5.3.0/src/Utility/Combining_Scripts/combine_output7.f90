...
!
!  On TYPHOON:
!  pgf90 -O2 -mcmodel=medium  -Bstatic -o combine_output7 ../UtilLib/argparse.F90 combine_output7.f90 ../UtilLib/schism_geometry.f90 -I/usr/local/amd64a/opteron/pgi/netcdf-3.6.2/include -L/usr/local/amd64a/opteron/pgi/netcdf-3.6.2/lib -lnetcdf
