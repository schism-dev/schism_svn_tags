...
!**********************************************************************
      ...
      REAL                  :: XCOOR(NTOTAL), YCOOR(NTOTAL), ZCOOR(NTOTAL)
      REAL                  :: XMIN, XMAX, YMIN, YMAX, ZMIN, ZMAX, DXIN, DYIN, DZIN, XYRATIO
...
!**********************************************************************
      ...
      REAL, INTENT(IN)      :: XRAY(M),YRAY(N)
      REAL, INTENT(IN)      :: ZMAT(M,N)
