...
!
      ...
      real(r8) :: solar_rad,rr,d_1,d_2
      real(r8) :: sdp1,sdp2,solar_rad1,solar_rad2
      integer :: i,k,water_type,ifec,itmp1,itmp2
      
! Sinking variables
      integer :: ks 
      integer, dimension(nvrt) :: ksource
      real(r8) :: cffR,cffL,dltR,dltL,cu,cff
      real(r8), dimension(nvrt) :: FC
      real(r8), dimension(nvrt) :: Hz_inv
      real(r8), dimension(nvrt) :: Hz_inv2
      real(r8) :: Hz_inv3
      real(r8), dimension(nvrt) :: qc
      real(r8), dimension(nvrt) :: qR
      real(r8), dimension(nvrt) :: qL
      real(r8), dimension(nvrt) :: WR
      real(r8), dimension(nvrt) :: WL
      real(r8), dimension(nvrt) :: Hz
