...
!     New from previous version: use S-T slope to generate temp. b.c.

!   Input: 
!     (1) nvrt,nond,ntracers,start_slope(1:2): # of vertical levels; # of nodes at mouth; # of tracers; S-T slope
...
!   ifort -Bstatic -O3 -assume byterecl -o gen_hot_2 gen_hot_2.f90
