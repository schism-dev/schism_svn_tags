...
#endif
!
         ALLOCATE( OUTT_INTPAR(MNP,OUTVARS) )
         ALLOCATE( CURR_INTPAR(MNP,CURRVARS) )
         ALLOCATE( WIND_INTPAR(MNP,WINDVARS) )
...
!**********************************************************************
      SUBROUTINE INITIAL_CONDITION(IFILE,IT)
         ...
         IF (.NOT. LHOTR .AND. LINID) THEN
            ...
            IF (INITSTYLE == 2 .AND. BOUNDFORMAT == 'WW3') THEN
            ...
            DO IP = 1, MNP
               ...
               IF (INITSTYLE == 1) THEN
                 ...
                 ELSE
                   ...
                   AC2(IP,:,:) = 0.0
                 END IF
              ELSE IF (INITSTYLE == 2 .AND. BOUNDFORMAT == 'WW3') THEN
