...
!											
!   ifort -Bstatic -mcmodel=medium -assume byterecl -O2 -o read_output7_xyz read_output7_xyz.f90 ../UtilLib/compute_zcor.f90 ../UtilLib/pt_in_poly.f90
!   pgf90 -O2 -mcmodel=medium -Mbounds -o read_output7_xyz read_output7_xyz.f90 ~/SCHISM/svn/trunk/src/Utility/UtilLib/compute_zcor.f90 ~/SCHISM/svn/trunk/src/Utility/UtilLib/pt_in_poly.f90
!   gfortran -ffree-line-length-none -O2 -o read_output7_xyz read_output7_xyz.f90 ~/SCHISM/svn/trunk/src/Utility/UtilLib/compute_zcor.f90 ~/SCHISM/svn/trunk/src/Utility/UtilLib/pt_in_poly.f90
!****************************************************************************************
!
      program read_out
      parameter(nbyte=4)
...
!        print*, 'time=',time/86400
        ...
        if(i23d==2) then
          ...
          enddo !i
          irec=irec+np*ivs
          write(18,'(e16.8,20000(1x,e14.6))')time/86400,(out2(i,1,1),i=1,nxy)
          if(ivs==2) write(19,'(e16.8,20000(1x,e14.6))')time/86400,(out2(i,1,2),i=1,nxy)
        else !i23d=3 
          do i=1,nxy
            do j=1,3 !nodes
              nd=node3(i,j)
...
!'
          ...
          enddo !i=1,nxy
          write(18,'(e16.8,20000(1x,f12.3))')time/86400,(out3(i,1),i=1,nxy)
          if(ivs==2) write(19,'(e16.8,20000(1x,f12.3))')time/86400,(out3(i,2),i=1,nxy)
