...
!       transect.out & transect_grd.[zr]0 (ascii on struc'ed grid; use plot_transect.m)

!       pgf90 -O2 -mcmodel=medium -Mbounds -o read_output7b_transect read_output7b_transect.f90 moving_average_filter.f90 ../UtilLib/compute_zcor.f90 ../UtilLib/pt_in_poly.f90
!											*
!****************************************************************************************
!
      program read_out
