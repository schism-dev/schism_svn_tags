...
!
! pgf90 -O2 -mcmodel=medium -Mbounds -Bstatic -o gen_nudge_from_nc gen_nudge_from_nc.f90 /sciclone/home04/yinglong/SELFE/svn/trunk/src/Utility/UtilLib/compute_zcor.f90 -I$NETCDF/include -L$NETCDF/lib -lnetcdf
