...
!-------------------------------------------------------------------------------
  ...
  !sediment fluxes
  real(kind=rkind),save :: JSI,JPO4,JNH4,JNO3,JHS,JCH4,JCH4AQ,JCH4G
  ...
  !SAV
  integer, save :: iSAV
  real(kind=rkind),save :: WSSSAV,WSLSAV,WSRSAV,WS1SAV,WS2SAV,WS3SAV,WSUSAV !effect on settling velocity
  real(kind=rkind),save,dimension(3) :: FRCSAV,FRNSAV,FRPSAV
  real(kind=rkind),save,allocatable,dimension(:) :: patch,sh
  real(kind=rkind),save,allocatable,dimension(:) :: SEDCSAV,SEDNSAV,SEDPSAV,SEDNH4SAV,SEDPO4SAV,SEDDOSAV
