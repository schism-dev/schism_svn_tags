program combine_cosine_output
!combine CoSiNE model station output and dump results into one file
!
!on viz3
!ifort -O2 -Bstatic -assume byterecl -o combine_cosine_output combine_cosine_output.f90

  implicit none
  integer, parameter :: rkind=8
  integer :: i,j,k,m,id,it,n,n1,n2,istat
  integer :: ne,np,nvrt,nproc,nstation,ntr,nday,iform
  integer :: ftell
  ...
  stop
end program combine_cosine_output
