...
! ifort -g -O3 -Bstatic -o readncomccs8a_intel readncomccs8a.f90 -Vaxlib -I/usr/local/netcdf/include/ -L/usr/local/netcdf/lib -lnetcdf
! Compilation on canopus01:
! ifort -g -O3 -Bstatic -o readncomccs8a_canopus readncomccs8a.f90 -Vaxlib -I/usr/local/include/ -L/usr/local/lib -lnetcdf
!
