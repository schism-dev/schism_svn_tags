...
!                  at invalid pts
!     (2) Z0.out: Z0 at the specified open bnds. The 1st column is Z0 @ beginning, and
!                 2nd column is Z0 @ end; "Invalid" if parent nodes are all dry
...
!     Output
      ...
      do l=1,nob
        ...
        k=iob(l)
        do i=1,nond(k)
          if(z0_out(1,l,i)<-98.or.z0_out(2,l,i)<-98) then
            write(22,*)'Invalid'
          else
            write(22,*)z0_out(1,l,i),z0_out(2,l,i)
          endif
        enddo !i
      enddo !l
