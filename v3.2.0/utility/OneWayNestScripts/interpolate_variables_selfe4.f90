...
!                  ifile rndays - ifile=1: generate elev3D.th; =2: salt3D.th 
!                  and temp3D.th; =3: uv3D.th); rndays is the # of days needed;
!              (5) binary outputs from large-domain run (*_elev.61 or *_temp.63 and *_salt.63, or *_hvel.64)
!       Outputs: 
...
!'
      irec_out=0
      it_tot=0
      do iday=1,max0(1,int(rndays*86400/dtout/nrec+0.1))
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
