      ...
      CHARACTER(LEN=2)                 :: MM, DD, hh, MIN, SEC
      ...
      INTEGER                          :: BUOYS, BUOYS_O, N_DT_SP, ERG, MSC, MDC
      ...
      REAL*8, ALLOCATABLE                :: FREQ  (:)  , D_FREQ(:)
      REAL, ALLOCATABLE                :: SPSIG(:), SPDIR(:)
      REAL*8, ALLOCATABLE                :: E     (:)  , NDIR  (:), DSPR  (:), COSTH(:), SINTH(:)
      REAL*8, ALLOCATABLE                :: AUX_M0(:)  , AUX_M1(:), AUX_M2(:), DS_BAND(:), DS_INCR(:)
      
      REAL*8, ALLOCATABLE                :: HS_SP (:,:), TM01_SP(:,:), TM02_SP(:,:)
      REAL*8, ALLOCATABLE                :: HS_SP_CLEAN (:,:), TM01_SP_CLEAN(:,:), TM02_SP_CLEAN(:,:)
      ...
      REAL*8     , ALLOCATABLE           :: DIFF3_HS_SP(:,:), DIFF3_TM01_SP(:,:), DIFF3_TM02_SP(:,:)
      REAL*8     , ALLOCATABLE           :: DIFF4_HS_SP(:,:), DIFF4_TM01_SP(:,:), DIFF4_TM02_SP(:,:)
      ...
      REAL*8     , ALLOCATABLE           :: KORR_HS(:), KORR_TM01(:), KORR_TM02(:)
