...
!                 Also beware the different connectivity tables from
!                 binary and hgrid.gr3 (the code works for both
!                 combine_outputs[89])!
!										
!	Inputs: 
...
!          d) *hvel.64, *vert.63, *elev.61, (*tdff.63, *wind.62 for oil spill)
!          e) (for advanced users of oil spill etc) some constants specified near the
!          beginning of the main routine (e.g. 'di')
...
!										
!	Output: particle.pth, particle.pth.more (more info), fort.16 (screen), fort.11 (fatal errors).		
!										
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!   ifort -O2 -mcmodel=medium -assume byterecl -Bstatic -o ptrack2 ptrack2.f90  ../../Utility/UtilLib/compute_zcor.f90  ../../Utility/UtilLib/schism_geometry.f90
!   gfortran -O2 -mcmodel=medium -Bstatic -o ptrack2 ptrack2.f90 ../UtilLib/compute_zcor.f90  ../UtilLib/schism_geometry.f90
...
!     has different conn table from hgrid.gr3)
      ...
      enddo
      print*, 'Starting stack =',ifile,st_m
      if(ibf==1) then
