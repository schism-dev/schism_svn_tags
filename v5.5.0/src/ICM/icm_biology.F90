...
!---------------------------------------------------------------------C
  ...
  use schism_msgp, only : myrank, parallel_abort
  use icm_mod, only : iCheck,isav_icm
  use misc_modules
  implicit none
...
!------------------------------------------------------------------------
  ...
  NH4T2TM1S(id) = NH4T2       !NH4 in 2nd layer
  NO3T2TM1S(id) = NO3T2       !NO3 in 2nd layer
  HST2TM1S(id)  = HST2        ! 
  SIT2TM1S(id)  = SIT2        !SAt in 2nd layer
  PO4T2TM1S(id) = PO4T2       !PO4 in 2nd layer
...
!------------------------------------------------------------------------------
  ...
  !use icm_sed_mod
  use icm_mod, only : dtw,AON,AOC,ANDC,isav_icm
  use schism_glbl, only : rkind
  implicit none 
