...
! Output: hotstart.nc 
!
!  ifort -O2 -CB -mcmodel=medium -assume byterecl -o convert_hotstart_nc convert_hotstart_nc.f90 -I$NETCDF/include -I$NETCDF_FORTRAN/include -L$NETCDF_FORTRAN/lib -L$NETCDF/lib -lnetcdf -lnetcdff
