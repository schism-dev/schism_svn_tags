...
! Output: hotstart.nc. 
!
!  ifort -O2 -CB -mcmodel=medium -assume byterecl -g -traceback -o combine_hotstart7.XX ../UtilLib/argparse.F90 combine_hotstart7.f90 -I$NETCDF/include -I$NETCDF_FORTRAN/include -L$NETCDF_FORTRAN/lib -L$NETCDF/lib -lnetcdf -lnetcdff
