...
!     &dramp_ss,ieos_type,ieos_pres,eos_a,eos_b,slr_rate,rho0,shw,isav,sav_cd,nramp_elev
...
!     Local variables
      ...
      integer :: i,j,k,l,m,mm,im2d,itmp,itmp1,itmp2,izonal5,nadv,ncor, &
                ...
                &ninv,it,kl,noutput_ns,iside,ntrmod,ntr_l,ncid2
...
!        itmp=indx_out(5,1)+i-1
      ...
      outfile(noutput+1)='PH.63'
      noutput=noutput+1

      outfile(noutput+1)='ICM_SED_BENDOC.66'
      outfile(noutput+2)='ICM_SED_BENNH4.66'
      outfile(noutput+3)='ICM_SED_BENNO3.66'
      outfile(noutput+4)='ICM_SED_BENPO4.66'
      outfile(noutput+5)='ICM_SED_BENCOD.66'
      outfile(noutput+6)='ICM_SED_BENDO.66'
      outfile(noutput+7)='ICM_SED_BENSA.66'
