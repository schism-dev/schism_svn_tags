...
!
      ...
      real(r8), dimension(NBands) :: ec_wave_ab =                        &
     ...
     &   6.7700e+02, 6.8200e+02, 6.8700e+02, 6.9200e+02, 6.9700e+02 /)
      ...
      real(r8), dimension(NBands) :: ec_Fobar =                          &
     ...
     &   1.4880e-01, 1.4660e-01, 1.4500e-01, 1.4350e-01, 1.4200e-01 /)
      ...
      real(r8), dimension(NBands) :: ec_aoz =                            &
     ...
     &   4.0400e-02, 3.6200e-02, 3.2000e-02, 2.7800e-02, 2.3800e-02 /)
      ...
      real(r8), dimension(NBands) :: ec_ag =                             &
     &(/ 0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,    &
     &   0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,    &
     &   0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,    &
     &   0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,    &
     ...
     &   0.0000e+00, 0.0000e+00, 8.1000e-01, 2.4800e-01, 0.0000e+00 /)
      ...
      real(r8), dimension(NBands) :: ec_aw =                             &
     &(/ 0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,    &
     &   0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,    &
     &   0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,    &
     &   0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,    &
     ...
     &   0.0000e+00, 8.0000e-04, 1.5000e-03, 1.9610e-01, 6.2070e-01 /)
      ...
      real(r8), dimension(Npig,NBands) :: apigs = reshape (              &
     ...
     & (/ Npig, NBands /) )
      ...
      !real(r8), dimension(Ndom,NBands) :: aDOC = reshape (               &
     ...
     !& (/ Ndom, NBands /) )
      ...
      real(r8), dimension(120), parameter :: aDOCall=                        &
     &	(/5.6832E+00,5.2989E+00,4.9407E+00,4.6067E+00,4.2952E+00,  &
     &	4.0049E+00,3.7341E+00,3.4817E+00,3.2463E+00,3.0268E+00,    &
     &	2.8222E+00,2.6314E+00,2.4535E+00,2.2876E+00,2.1330E+00,    &
     &	1.9888E+00,1.8543E+00,1.7289E+00,1.6121E+00,1.5031E+00,    &
     &	1.4014E+00,1.3067E+00,1.2184E+00,1.1360E+00,1.0592E+00,    &
     &	9.8758E-01,9.2082E-01,8.5857E-01,8.0052E-01,7.4640E-01,    &
     &	6.9594E-01,6.4889E-01,6.0502E-01,5.6412E-01,5.2598E-01,    &
     &	4.9042E-01,4.5726E-01,4.2635E-01,3.9753E-01,3.7065E-01,    &
     &	3.4559E-01,3.2223E-01,3.0044E-01,2.8013E-01,2.6119E-01,    &
     &	2.4354E-01,2.2707E-01,2.1172E-01,1.9741E-01,1.8406E-01,    &
     &	1.7162E-01,1.6001E-01,1.4920E-01,1.3911E-01,1.2970E-01,    &
     &	1.2094E-01,1.1276E-01,1.0514E-01,9.8029E-02,9.1402E-02,    &
     &	6.2086E+00,5.4791E+00,4.8353E+00,4.2671E+00,3.7657E+00,    &
     &	3.3232E+00,2.9327E+00,2.5881E+00,2.2840E+00,2.0156E+00,    & 
     &	1.7788E+00,1.5698E+00,1.3853E+00,1.2225E+00,1.0789E+00,    &
     &	9.5212E-01,8.4024E-01,7.4151E-01,6.5438E-01,5.7749E-01,    &
     &	5.0963E-01,4.4975E-01,3.9690E-01,3.5027E-01,3.0911E-01,    &
     &	2.7279E-01,2.4073E-01,2.1245E-01,1.8748E-01,1.6545E-01,    &
     &	1.4601E-01,1.2886E-01,1.1371E-01,1.0035E-01,8.8561E-02,    &
     &	7.8155E-02,6.8971E-02,6.0867E-02,5.3715E-02,4.7403E-02,    &
     &	4.1833E-02,3.6918E-02,3.2580E-02,2.8752E-02,2.5373E-02,    &
     &	2.2392E-02,1.9761E-02,1.7439E-02,1.5390E-02,1.3581E-02,    &
     &	1.1985E-02,1.0577E-02,9.3343E-03,8.2375E-03,7.2695E-03,    &
     &	6.4153E-03,5.6615E-03,4.9963E-03,4.4092E-03,3.8911E-03/)


      real(r8),dimension(Ndom,NBands) :: aDOC=-99.d0  

      real(r8), dimension(NBands) :: awater =                            &
     ...
     &   4.5696e-01, 4.7460e-01, 4.9848e-01, 5.3344e-01, 5.8524e-01 /)
      ...
      real(r8), dimension(NBands) :: bwater =                            &
