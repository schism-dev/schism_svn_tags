...
!
!  Compile on tsunami:
!  ifort -Bstatic -O2 -assume byterecl -o combine_output7 combine_output7.f90 argparse.F90 schism_geometry.f90 -Vaxlib -I/share/apps/netcdf/include/ -L/share/apps/netcdf/lib/ -lnetcdf
!  On TYPHOON:
!  pgf90 -O2 -mcmodel=medium  -Bstatic -o combine_output7 combine_output7.f90 argparse.F90 ~yinglong/SCHISM/svn/trunk/src/Utility/UtilLib/schism_geometry.f90 -I/usr/local/amd64a/opteron/pgi/netcdf-3.6.2/include -L/usr/local/amd64a/opteron/pgi/netcdf-3.6.2/lib -lnetcdf
...
call combine_output7_input(files,nfile,ibgn,iend,inetcdf)
call combine_output7(files,nfile,ibgn,iend,inetcdf)
end program


subroutine combine_output7(files,nfile,ibgn,iend,inc)
!-------------------------------------------------------------------------------
!  use typeSizes
!  use netcdf
...
!     Write mode (header part only)
  ...
  stop
end subroutine combine_output7



subroutine combine_output7_input(files,nfile,ibgn,iend,inetcdf)
use argparse
implicit none
integer, parameter                   :: nfilemax = 20
integer                              :: nfile   !< number of file base names
