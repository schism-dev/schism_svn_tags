...
module fabm_schism
  ...
  use schism_glbl, only: ntracers,nvrt,tr_el,tr_nd,erho,idry_e,nea,npa,ne,np,bdy_frc,flx_sf,flx_bt,dt,elnode,i34,srad,windx,windy,ze,kbe,wsett,ielg,iplg,xnd,ynd,rkind,xlon,ylat,lreadll,iwsett,irange_tr
  use schism_msgp
