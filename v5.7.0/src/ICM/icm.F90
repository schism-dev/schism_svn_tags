...
!--------------------------------------------------------------------------------
  ...
  elseif(imode==2) then
    ...
    do k=kbe(id)+1,nvrt
      ...
      tr_el(7+irange_tr(1,7),k,id)=DOC(m,1)
      ...
      tr_el(20+irange_tr(1,7),k,id)=DOO(m,1)
      Chl_el(k,id)=PB1(m,1)/CChl1(id)+PB2(m,1)/CChl2(id)+PB3(m,1)/CChl3(id)
      PrmPrdt(k,id)=PB1(m,1)*GP(m,1)+PB2(m,2)*GP(m,2)+PB3(m,2)*GP(m,3)
      DIN_el(k,id)=NH4(m,1)+NO3(m,1)
      PON_el(k,id)=RPON(m,1)+LPON(m,1)
