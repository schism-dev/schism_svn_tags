...
!-------------------------------------------------------------------------------
  ...
  real(kind=rkind), save,allocatable,dimension(:,:) :: FRPOP,FRPON,FRPOC !(1:nea,3), leave option for mapping
  ...
  real(kind=rkind),save :: ZHTANH4F,ZHTANH4S,ZHTAD1,ZHTAP1,ZHTANO3F,ZHTANO3S,ZHTA2NO3,ZL12NOM,ZW12NOM,ZHTAPON1,ZHTAPON2,ZHTAPON3
  real(kind=rkind),save :: ZHTAPOC1,ZHTAPOC2,ZHTAPOC3,ZHTAPOP1,ZHTAPOP2,ZHTAPOP3,ZHTASI,ZHTACH4,ZHTAI0,ZHTAR,ZHTABETA
