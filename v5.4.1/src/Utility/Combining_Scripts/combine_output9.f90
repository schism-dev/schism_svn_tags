...
! Usage: ./combine_output9 -h for help
! Inputs:
...
!  ifort -cpp -O2 -Bstatic -assume byterecl -o combine_output9 netcdf_var_names.f90 combine_output9.f90 ../UtilLib/schism_geometry.f90 ../UtilLib/argparse.F90 -I$NETCDF/include -L$NETCDF/lib -lnetcdf 
!  pgf90 -O2 -mcmodel=medium -Bstatic -Mpreprocess -o combine_output9 netcdf_var_names.f90 combine_output9.f90 ../UtilLib/schism_geometry.f90 ../UtilLib/argparse.F90 -I$NETCDF/include -L$NETCDF/lib -lnetcdf -I../UtilLib
!  gfortran -cpp -O2 -mcmodel=medium -ffree-line-length-none -o ne_output9 netcdf_var_names.f90 combine_output9.f90 ../UtilLib/schism_geometry.f90 ../UtilLib/argparse.F90 -I/usr/include -I$NETCDF/include -L$NETCDF/lib -lnetcdf -lnetcdff -I../UtilLib
...
! Read local_to_global_0000 for global info
  ...
  do ifile = 1,nfile
    ...
    !     enter define mode
          fname=it_char(1:it_len)//'_'//file63(1:lfile63-3)//'_'//file63((lfile63-1):lfile63)//'.nc'
#ifdef NETCDF_4
          iret = nf_create(trim(fname), OR(NF_CLOBBER,NF_NETCDF4,NF_CLASSIC_MODEL), ncid)
#else
