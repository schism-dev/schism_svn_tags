...
!									
!       pgf90 -O2 -mcmodel=medium -Mbounds -o read_output7b_xyt read_output7b_xyt.f90 ~/SCHISM/svn/trunk/src/Utility/UtilLib/compute_zcor.f90 ~/SCHISM/svn/trunk/src/Utility/UtilLib/pt_in_poly.f90
!       gfortran -ffree-line-length-none -O2 -o read_output7b_xyt read_output7b_xyt.f90 ~/SCHISM/svn/trunk/src/Utility/UtilLib/compute_zcor.f90 ~/SCHISM/svn/trunk/src/Utility/UtilLib/pt_in_poly.f90
!****************************************************************************************
!
      program read_out
      parameter(nbyte=4)
