...
!****************************************************************************************
!     ifort -Bstatic -O2 -assume byterecl -o read_output7_allnodes read_output7_allnodes.f90 ~/SCHISM/svn/trunk/src/Utility/UtilLib/compute_zcor.f90
!     pgf90 -O2 -mcmodel=medium -Mbounds -o read_output7_allnodes read_output7_allnodes.f90 ~/SCHISM/svn/trunk/src/Utility/UtilLib/compute_zcor.f90
      program read_out
      parameter(nbyte=4)
      character*30 file63
...
!         Output: time, 2D variable at all nodes
          write(65,'(e14.6,1000000(1x,e14.4))')time/86400,((out(i,1,m),m=1,ivs),i=1,np)
