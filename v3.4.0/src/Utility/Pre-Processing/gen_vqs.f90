...
!    ifort -Bstatic -O2 -CB -o gen_vqs gen_vqs.f90 ~/SELFE/svn/trunk/src/Utility/UtilLib/selfe_geometry.f90
!    pgf90 -O2 -mcmodel=medium  -Bstatic -o gen_vqs gen_vqs.f90 ~/SELFE/svn/trunk/src/Utility/UtilLib/selfe_geometry.f90
