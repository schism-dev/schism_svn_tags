...
!                        2\n 2\n;
!          (5) interpolate_variables_selfe.in (see sample in this dir):
...
!									
!       ifort -Bstatic -O3 -assume byterecl -CB -o interpolate_variables_selfe5 interpolate_variables_selfe5.f90 ~/SELFE/svn/trunk/src/Utility/Post-Processing-Fortran/compute_zcor.f90
!       pgf90 -O2 -mcmodel=medium -Mbounds -Bstatic -o interpolate_variables_selfe5 interpolate_variables_selfe5.f90 ~/SELFE/svn/trunk/src/Utility/Post-Processing-Fortran/compute_zcor.f90
!********************************************************************************
!
      program interpolate
