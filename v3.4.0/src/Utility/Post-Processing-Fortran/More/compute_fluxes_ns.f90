...
!       History: 
!****************************************************************************************
!     ifort -Bstatic -O2 -assume byterecl -o compute_fluxes_ns compute_fluxes_ns.f90 /home/users/yinglong/SELFE/svn/trunk/src/utility/Combining_Scripts/selfe_geometry.f90
      program read_out
      parameter(nbyte=4)
      character*30 file63
...
!     Compute geometry
      ...
      call selfe_geometry(np,ne,ns2,x,y,elnode,ic3,elside,isdel,isidenode,xcj,ycj)
      print*, 'done selfe_geometry'
