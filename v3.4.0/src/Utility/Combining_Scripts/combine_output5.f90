...
!  ifort -Bstatic -O3 -assume byterecl -o combine_output5 combine_output5.f90 selfe_geometry.f90 -Vaxlib -I/usr/local/include/ -L/usr/local/lib -lnetcdf

!  Compile on amb6402:
!  ifort -Bstatic -O3 -assume byterecl -o combine_output5 combine_output5.f90 selfe_geometry.f90 -Vaxlib -I/usr/local/netcdf/include/ -L/usr/local/netcdf/lib -lnetcdf
!
!  On Ranger:
!  pgf90 -O2 -mcmodel=medium  -Bstatic -o combine_output5 combine_output5.f90 selfe_geometry.f90 .....
