...
!
!  ifort -Bstatic -O2 -assume byterecl -o combine_output8 combine_output8.f90 ...../selfe_geometry.f90 -Vaxlib -I/share/apps/netcdf/include/ -L/share/apps/netcdf/lib/ -lnetcdf

!  On TYPHOON:
!  pgf90 -O2 -mcmodel=medium  -Bstatic -o combine_output8 combine_output8.f90 -Mbounds /sciclone/home04/yinglong/SELFE/svn/branches/quads/src/Utility/UtilLib/selfe_geometry.f90 \
...
! Compute geometry
  call compute_nside(np_global,ne_global,i34,elnode,ns2)
  ...
  call selfe_geometry(np_global,ne_global,ns2,x,y,i34,elnode,ic3,elside,isdel,isidenode,xcj,ycj)
...
! Compute side/element bottom index
  do i=1,ne_global
    kbe(i)=maxval(kbp00(elnode(1:i34(i),i)))
