...
!										
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!   ifort -Bstatic -O2 -assume byterecl -o ptrack_selfe2 ptrack_selfe2.f90
!   pgf90 -O2 -mcmodel=medium  -Bstatic -o ptrack_selfe2 ptrack_selfe2.f90
...
!     Compute ball info
      do i=1,ne
        do j=1,3
          ...
          do k=1,nne(nd1)
            iel=indel(k,nd1)
            if(iel/=i.and.(elnode(1,iel)==nd2.or.elnode(2,iel)==nd2.or.elnode(3,iel)==nd2)) ic3(j,i)=iel
          enddo !k
        enddo !j
      enddo !i
