...
!- Display user-defined parameters ----------------------------------
  ...
  WRITE(idsed2d,FMT1)'  rho0      = ',rho0
  WRITE(idsed2d,FMT1)'  rhos      = ',rhos
  WRITE(idsed2d,FMT1)'  nu        = ',nu
  WRITE(idsed2d,FMT1)'  poro      = ',poro
  WRITE(idsed2d,FMT1)'  d50       = ',d50
  WRITE(idsed2d,FMT1)'  d90       = ',d90
  WRITE(idsed2d,FMT1)'  depth     = ',h
  WRITE(idsed2d,FMT1)'  u         = ',u
  WRITE(idsed2d,FMT1)'  v         = ',v
  WRITE(idsed2d,FMT1)'  dpdx      = ',dpdx
  WRITE(idsed2d,FMT1)'  dpdy      = ',dpdy
  WRITE(idsed2d,FMT1)'  urms      = ',urms
  WRITE(idsed2d,FMT1)'  hs        = ',hs 
  WRITE(idsed2d,FMT1)'  tp        = ',tp
  WRITE(idsed2d,FMT1)'  wl        = ',wl
  WRITE(idsed2d,*)''
...
!- Display thresholds parameters ------------------------------------
  ...
  WRITE(idsed2d,FMT1)'  D*          = ',D_star
  WRITE(idsed2d,FMT1)'  Ucr_c       = ',Ucr_c
  WRITE(idsed2d,FMT1)'  Ucr_w       = ',Ucr_w
  WRITE(idsed2d,FMT1)'  theta_cr    = ',theta_cr
  WRITE(idsed2d,FMT1)'  tau_cr      = ',tau_cr
  WRITE(idsed2d,*)''
...
!- Display bedforms roughness ---------------------------------------
  ...
  CALL bedform_predictor_s97(d50,h,u,v,urms,tp,tau_cr,theta_cr,z0cr, &
                             z0wr,z0sw,z0)
  WRITE(idsed2d,FMT1)'  z0 current-ripples = ',z0cr
  WRITE(idsed2d,FMT1)'  z0 wave-ripples    = ',z0wr
  WRITE(idsed2d,FMT1)'  z0 sandwave        = ',z0sw
  WRITE(idsed2d,FMT1)'  z0 total           = ',z0
  WRITE(idsed2d,*)''

!- Display friction parameters --------------------------------------
  WRITE(idsed2d,*)'*** Friction parameters ***'
  WRITE(idsed2d,FMT1)'  z0 skin     = ',z0
  WRITE(idsed2d,FMT1)'  z0 ripple   = ',z0
  WRITE(idsed2d,FMT1)'  z0 sandwave = ',z0

  CALL compute_drag(d50,h,z0,u,v,2,Cd)
  WRITE(idsed2d,FMT1)'  Cd (z0s)    = ',Cd
  s = rhos/rho0
  tau0 = rho0*Cd*u*u
  theta0 = tau0/(grav*rho0*(s-1.d0)*d50)
  WRITE(idsed2d,FMT1)'  tau0s       = ',tau0
  WRITE(idsed2d,FMT1)'  theta0s       = ',theta0
  CALL compute_drag(d50,h,z0,u,v,2,Cd)
  WRITE(idsed2d,FMT1)'  Cd (z0r)    = ',Cd
  CALL compute_drag(d50,h,z0,u,v,2,Cd)
  WRITE(idsed2d,FMT1)'  Cd (z0sw)   = ',Cd
  CALL compute_drag(d50,h,z0,u,v,3,Cd)
  WRITE(idsed2d,FMT1)'  Cd alluvial = ',Cd
  WRITE(idsed2d,*)''
...
!- Display transport rate -------------------------------------------
  ...
  WRITE(idsed2d,FMT1)'  Q total     = ',DSQRT(qtot(1)**2+qtot(2)**2)
  WRITE(idsed2d,*)''
  ...
  WRITE(idsed2d,FMT1)'  Q bedload   = ',DSQRT(qb(1)**2+qb(2)**2)
  CALL svr97_susp(Cd,d50,u,v,D_star,Ucr_c,urms,qs)
  WRITE(idsed2d,FMT1)'  Q suspended = ',DSQRT(qs(1)**2+qs(2)**2)
