...
fn.runDir = '/home/workspace/ccalmr35/elcirc/201_calib_series/';
...
h=sz_readHeader(fullfile(fn.runDir,'outputs/1_0000_elev.61'));
gr.vgrid=h.vgrid;
...
h=sz_readHeader(fullfile(fn.runDir,'outputs/1_0000_hvel.64'));
...
[e ts]=sz_readTimeStep(h,1,fullfile(fn.runDir,'outputs/1_0000_elev.61'));
gr_plot(gr.hgrid,e); %elevation
